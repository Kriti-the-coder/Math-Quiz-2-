...
function send()
{
    ...
    input_box = "<br>Answer: <input type='text' id='ans_input' placeholder='Enter Answer'>";
    check_btn = "<br><br> <button class='btn btn-info' id='btn-check' onclick='check()'>Check</button>";
